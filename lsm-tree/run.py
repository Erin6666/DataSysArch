...
actions = ['put_sorted', 'put_unsorted', 'get_sorted', 'get_unsorted', 'update_sorted', 'update_unsorted', 'delete_unsorted', 'delete_sorted'] 
...
for a in actions:
	for ds in data_sizes: 
		for bs in buffer_sizes: 
		        ...
		        call(["./lsm", ds, bs, num_ops,a[:3]], stdout=f)
